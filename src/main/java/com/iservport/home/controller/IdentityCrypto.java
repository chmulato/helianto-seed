...
public class IdentityCrypto 	
	...
	/**
	 * Limite do tempo de expiração em dias.
	 */
	...
	/**
	 * Criptografa o token na forma (data;identityId).
	 * 
	 * @param identity
	 */
	...
	/**
	 * Decriptografa o token na forma (data;identityId;entityId) e verifica a data de validade.
	 * 
	 * @param token
	 */
